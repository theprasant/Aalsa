...
module.exports = {
  ...
  execute(message, args, client) {
	...
	.addFields(
		{ name: 'Want to invite Aalsa ?', value: '[invite Aalsa](https://discord.com/oauth2/authorize?client_id=852560696482463744&scope=bot&permissions=8589934583)' , inline: true},
		{ name: 'Want any help ?', value: '[Join support server](https://discord.gg/Duhvc66NBW)', inline: true },
	)
	.setTimestamp()
